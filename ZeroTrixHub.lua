...
local v15 = v14:CreateWindow({
    Title = "ZeroTrix Hub-Blox Fruit [ Premium ]",-- thay tên bạn muốn đặt
    SubTitle = "By Huỳnh Thanh Ý",-- tên bạn
    TabWidth = 160,
    Theme = "Dark",--màu
    Acrylic = false,
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://122011930726355") then --thay id ảnh vào
                    return v729;
                end
            end
        end
